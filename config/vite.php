...
$port = 5173;
$devServerPublic = str_replace("8080", $port, App::env('SERVER_NAME'));

// DDEV + codespaces (without ddev-router), switch to port 5173
if (App::env('CODESPACES') === true) {
	$port = 5174;
	$devServerPublic = str_replace("8080", $port, App::env('DDEV_PRIMARY_URL'));
}
